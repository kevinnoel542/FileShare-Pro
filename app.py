...
ALLOWED_EXTENSIONS = {
    ...
    'mpeg', 'mpg', 'm4v', '3gp', '3g2', 'ts', 'zip', 'mp3', 'srt','x', 'xls', 'docx', 'doc', 'pptx', 'ppt','exe', 'apk', 'csv', 'json', 'xml', 'html', 'css', 'js','m4a', 'wav', 'ogg', 'flac', 'aac', 'midi', 'bmp', 'tiff', 'svg', 'webp','rar', '7z', 'tar', 'gz', 'bz2', 'dmg', 'iso', 'psd', 'ai', 'eps', 'indd', 'odt', 'odp', 'ods','odg', 'md', 'txt', 'log', 'yaml', 'yml', 'conf', 'cfg', 'properties', 'bat', 'sh', 'ps1','vbs', 'py', 'rb', 'go', 'java', 'c', 'cpp', 'h', 'hpp', 'cs', 'rs', 'swift', 'kt','dart','ts', 'tsx', 'jsx', 'html', 'php', 'asp', 'aspx', 'jsp', 'sql', 'db', 'sqlite', 'mdb','accdb', 'bak', 'tmp','torrent', 'epub', 'mobi', 'azw3', 'fb2', 'cbz', 'cbr', 'chm', 'docm', 'dotx','dotm', 'xltx', 'xltm', 'xlam', 'xlsb', 'xltm', 'pptm', 'potx', 'potm', 'ppam'
}
...
# NEW: Function to detect file type for icon/action display
...
# Modified to include 'type' for each file
    ...
    for filename in os.listdir(folder_path):
        ...
        if os.path.isfile(path):
            ...
            files.append({
                ...
                'type': get_file_type(filename)  # <-- added
            })
...
def imported_upload():
    ...
    if file and allowed_file(file.filename):
        ...
        # Add timestamp if file exists to avoid overwrite
...
@app.route('/imported/files/<filename>', methods=['DELETE'])  # ✅ matches your frontend fetch
...
if __name__ == '__main__':
    # No file size limit set intentionally
